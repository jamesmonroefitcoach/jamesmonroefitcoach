...
export const LIBRARY_HIERARCHY: LibraryGroup[] = [
    ...
    nodes: [
      { id: "back-extension", label: "Back extension", category: "hinge" },
      {
        ...
        children: [
          ...
          { id: "bird-dog",        label: "Bird Dog",        category: "core" },
          { id: "hip-circles",     label: "Hip Circles",     category: "core" },
          { id: "dead-bugs",       label: "Dead Bugs",       category: "core" },
          { id: "heel-taps",       label: "Heel Taps",       category: "core" },
          { id: "plank",           label: "Plank",           category: "core" },
          { id: "reverse-plank",   label: "Reverse Plank",   category: "core" },
          { id: "side-crunch",     label: "Side Crunch",     category: "core" },
          { id: "oblique-chop",    label: "Oblique Chop",    category: "core" },
          { id: "plank-up",        label: "Plank Up",        category: "core" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    nodes: [
      ...
      {
        id: "plyometric", label: "Plyometric", category: "cardio",
        children: [
          { id: "box-jump",            label: "Box Jump",            category: "cardio" },
          { id: "chest-pass",          label: "Chest Pass",          category: "cardio" },
          { id: "floor-throws",        label: "Floor Throws",        category: "cardio" },
          { id: "oblique-throws",      label: "Oblique Throws",      category: "core"   },
          { id: "skiers",              label: "Skiers",              category: "cardio" },
          { id: "transverse-box-jump", label: "Transverse Box Jump", category: "cardio" },
        ],
      },
      {
        id: "saq", label: "SAQ", category: "cardio",
        children: [
    ...
    nodes: [
      {
        ...
        children: [
          { id: "stretch-90-90",      label: "90/90",            category: "mobility" },
          { id: "stretch-adductor",   label: "Adductor",         category: "mobility" },
          { id: "stretch-foam-roll",  label: "Foam Roll",        category: "mobility" },
          { id: "stretch-hamstring",  label: "Hamstring",        category: "mobility" },
          { id: "stretch-iron-cross", label: "Iron Cross",       category: "mobility" },
          { id: "stretch-worlds",     label: "World's Greatest", category: "mobility" },
        ],
      },
      {
        id: "yoga", label: "Yoga", category: "mobility",
        children: [
          { id: "yoga-chair",         label: "Chair Pose",   category: "mobility" },
          { id: "yoga-tree",          label: "Tree Pose",    category: "mobility" },
          { id: "yoga-warrior-1",     label: "Warrior 1",    category: "mobility" },
          { id: "yoga-warrior-3",     label: "Warrior 3",    category: "mobility" },
          { id: "yoga-downward-dog",  label: "Downward Dog", category: "mobility" },
          { id: "yoga-chaturanga",    label: "Chaturanga",   category: "mobility" },
          { id: "yoga-cobra",         label: "Cobra",        category: "mobility" },
          { id: "yoga-spinal-twist",  label: "Spinal Twist", category: "mobility" },
          { id: "yoga-side-bridge",   label: "Side Bridge",  category: "mobility" },
          { id: "yoga-back-bridge",   label: "Back Bridge",  category: "mobility" },
          { id: "yoga-boat",          label: "Boat Pose",    category: "mobility" },
        ],
      },
    ],
  },
