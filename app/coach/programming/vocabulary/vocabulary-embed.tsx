...
// Auto-sizing embed for /exercise-vocabulary.html — the printable movement list.
//
...
export default function VocabularyEmbed() {
  ...
  return (
    <iframe
      ref={ref}
      src="/exercise-vocabulary.html"
      title="Exercise Vocabulary"
      onLoad={onLoad}
      style={{
        width: "100%",
        minHeight: 700,
